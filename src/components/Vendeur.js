...
class Vendeur extends React.Component {
  render() {
    return (
      <Card id="cardVendeur">
        <Card.Header as="h5">Espace Vendeur</Card.Header>
        <Card.Body>
          <Tab.Container id="tabs-gestion">
            <Row>
              <Col sm={3}>
                <Nav variant="pills" className="flex-column mb-4">
                  <Nav.Link as={NavLink} to="/vendeur/articles">
                    Articles
                  </Nav.Link>
                  <Nav.Link as={NavLink} to="/vendeur/ajouter">
                    Ajouter
                  </Nav.Link>
                  <Nav.Link as={NavLink} to="/vendeur/modifier">
                    Modifier
                  </Nav.Link>
                  <Nav.Link as={NavLink} to="/vendeur/commandes">
                    Commandes
                  </Nav.Link>
                </Nav>
              </Col>
              <Col sm={9}>
                <Tab.Content>
                  <Route
                    ...
                    component={ListArticlesVendeur}
                  />
                  <Route
                    exact
                    path="/vendeur/ajouter"
                    component={AddArticleVendeur}
                  />
                  <Route
                    path="/vendeur/modifier/:articleID?"
                    component={ModifyArticleVendeur}
                  />
